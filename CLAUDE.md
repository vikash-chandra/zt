...
| Strategy | `ACTIVE_STRATEGIES`, `ACTIVE_SELECTORS`, `STRATEGY_SELECTOR_MAP`, `LV_TRADE_END_TIME`, `SECTOR_MAX_BUY_PCT`, `SECTOR_MAX_SELL_PCT`, `STOCK_MAX_BUY_PCT`, `STOCK_MAX_SELL_PCT`, `VB_MASTER_MAX_PCT`, `VB_SL_MIN_PCT`, `VB_SL_MAX_PCT`, `VB_MIN_GAP_PCT`, `VB_TRADE_END_TIME` |
