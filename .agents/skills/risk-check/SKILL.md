...
3. Check Options Trading Risk Controls (`OPTIONS_SUPERTREND`):
   ...
   - Option Premium Stop-Loss: 50% premium increase (`OPTIONS_SL_PCT=0.50`)
   - Post-SL Entry Guard: Freeze duplicate entries on breached trend until next SuperTrend direction flip
